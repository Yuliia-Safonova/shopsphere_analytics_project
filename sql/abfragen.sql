...
-- shopsphere_products, shopsphere_orders, shopsphere_order_items, shopsphere_marketing), die zuvor in
...
SELECT
    ...
    ROUND(
        SUM(total_spent) * 100.0 / (SELECT SUM(net_amount) FROM shopsphere_orders),
        2
