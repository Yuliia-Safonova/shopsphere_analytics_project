...
-- In den betroffenen Abfragen (1.2 und 1.5) werden diese Spalten daher per AS wieder
-- auf ihren ursprünglichen, vollständigen Namen umbenannt, um Konsistenz mit der
-- Aufgabenstellung und mit Tableau zu gewährleisten.
-- =====================================================================
