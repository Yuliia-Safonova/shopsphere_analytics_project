...
│
├── sql/
│   └── abfragen.sql               ← SQL-Abfragen aus Block 1 sowie Zusatzabfragen aus Block 2 (z. B. Aufgabe 2.6), kommentiert
│
...
│
└── tableau/
    └── README_tableau.md          ← Link zum Tableau-Workbook, Übersicht der Blätter, später Dashboard-Beschreibung
```
...
| Block 2 – Visualisierungen in Tableau | 🔄 in Arbeit (5 von 6 Visualisierungen fertig) |
| Block 3 – Dashboard für die CEO | ⏳ ausstehend |
| Block 4 – Strategische Geschäftsfälle | ⏳ ausstehend |
